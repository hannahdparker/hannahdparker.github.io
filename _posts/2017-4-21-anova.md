...
<center><img src="/images/Manute-Bol-Muggsy-Bogues.jpg" width="350" height="450"></center>
...
One thing to note with the normality assumption: we can also test the
residuals, or errors, from our model rather than testing the data 
within each group.
...
between divisions. The p-value is based on the F-value, which is the ratio
of the variance between groups, to the variance within groups. The more
varied the groups with each other and the less they're varied within, the
more likely we'll get a significant result!
