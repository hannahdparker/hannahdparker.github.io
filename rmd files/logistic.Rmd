...
ggplot(pacers, aes(x=FG., y=as.numeric(W.L)-1)) +
  geom_point() +
  stat_smooth(method="lm", formula = y ~ x, se=F) +
  stat_smooth(method="glm", method.args=list(family="binomial"), formula = y ~ x, se=F, col="red") +
  labs(x="FG%", y="Probability of Win")
```
