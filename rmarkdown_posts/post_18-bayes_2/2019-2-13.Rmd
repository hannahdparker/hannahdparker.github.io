...
see it at its full power. Rather than limiting ourselves to single value priors, we can use a full distribution as a prior. In this post, we'll see a Bayesian example with an expanded our prior and compare it to the more traditional frequentist methodology.
...
and $Y$ represent; $X$ with ![](https://latex.codecogs.com/gif.latex?%5Ctheta), our prior beliefs, and
$Y$ with <a href="https://www.codecogs.com/eqnedit.php?latex=data" target="_blank"><img src="https://latex.codecogs.com/gif.latex?data" title="data" /></a>. This makes our equation:
